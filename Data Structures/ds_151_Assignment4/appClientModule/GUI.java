...
/////////////////////////////////////////////////////////////////////////
    ...
    JRadioButtonMenuItem firstSolution, secondSolution, thirdSolution;
...
/////////////////////////////////////////////////////////////////////////
    private void jbInit() throws Exception {
        ...
        titledBorder7 = new TitledBorder(BorderFactory.createMatteBorder(6, 6, 6, 6, Color.red), "DS151 - FaceBook");
        ...
        thirdSolution = new JRadioButtonMenuItem("thirdSolution");
        group.add(thirdSolution);
        workingModes.add(thirdSolution);
...
/////////////////////////////////////////////////////////////////////////
////           update the update List method    - DONT TOUCH                     
/////////////////////////////////////////////////////////////////////////
	...
	public String[] thirdSolution(int leftTopX, int leftTopY, int rightBottomX,
			int rightBottomY) {
		return studentSolution.thirdSolution(leftTopX, leftTopY, rightBottomX, rightBottomY);
	}
...
//    private TexturePaint imagePaint2;
    ...
    public void mouseReleased(MouseEvent e) {
        ...
        myGUI.updateOutputList(myGUI.secondSolution(Math.min(startX,tmpX),Math.min(startY,tmpY),
        		Math.max(startX,tmpX),Math.max(startY,tmpY)));
        if(myGUI.thirdSolution.isSelected())
        myGUI.updateOutputList(myGUI.thirdSolution(Math.min(startX,tmpX),Math.min(startY,tmpY),
        		Math.max(startX,tmpX),Math.max(startY,tmpY)));
    }
